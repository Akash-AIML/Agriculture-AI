...
// ── Context badge ─────────────────────────────────────────────────────────────
function CtxBadge({ icon, label, active }) {
      ...
      <View style={{ flex: 1, maxWidth: maxW, width: '100%', alignSelf: 'center' }}>
        ...
        <Surface style={[s.header, { paddingTop: insets.top + 10 }, SH.sm]} elevation={2}>
          <View style={s.headerTop}>
            ...
            {/* Context badges */}
            <HStack style={{ gap: 4 }}>
              <CtxBadge icon="🔬" label="Disease" active={!!analysisResults?.disease} />
              <CtxBadge icon="🪨" label="Soil"    active={!!analysisResults?.soil}    />
              <CtxBadge icon="🌾" label="Crop"    active={!!analysisResults?.crop}    />
            </HStack>
          </View>
